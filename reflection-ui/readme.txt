 ...
 without coding (or with very few coding=). Since there is not enough information 
 in objects to build a user friendly UI, enrichment and customization are then needed.
 ...
 oriented model: Classes are ITypeInfo objects, field are IFielInfo objects, etc.
 ...
 Remark: the ItemPosition works in conjunction with the IFieldInfo or IMethodInfo it associated 
