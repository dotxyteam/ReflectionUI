...
import xy.reflect.ui.example.Calculator;
import xy.reflect.ui.example.FileExplorer;
...
public class MinimalTest {
	...
	public void testFileExplorer() throws Exception {
		...
		customizedUI.getInfoCustomizations().loadFromStream(FileExplorer.class.getResourceAsStream("fileExplorer.icu"),
	...
	public void testCalculator() throws Exception {
		...
		customizedUI.getInfoCustomizations().loadFromStream(Calculator.class.getResourceAsStream("calculator.icu"),
				ReflectionUIUtils.getDebugLogListener(customizedUI));
