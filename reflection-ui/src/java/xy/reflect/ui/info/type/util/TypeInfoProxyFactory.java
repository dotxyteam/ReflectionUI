...
public class TypeInfoProxyFactory {
	...
	protected boolean isValueDetached(IFieldInfo field, ITypeInfo containingType) {
		return field.isValueDetached();
	}
	...
	private class GeneratedFieldInfoProxy implements IFieldInfo {
		...
		public boolean isValueDetached() {
			return TypeInfoProxyFactory.this.isValueDetached(field, containingType);
		}
	...
	private class GeneratedMethodInfoProxy implements IMethodInfo {
		...
		public boolean isReturnValueDetached() {
			return TypeInfoProxyFactory.this.isReturnValueDetached(method, containingType);
		}
