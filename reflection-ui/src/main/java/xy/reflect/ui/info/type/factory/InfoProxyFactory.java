...
public class InfoProxyFactory implements IInfoProxyFactory {
	...
	@Override
	public IFieldInfo unwrapFieldInfo(final IFieldInfo field, ITypeInfo objectType) {
	...
	@Override
	public IMethodInfo unwrapMethodInfo(final IMethodInfo method, ITypeInfo objectType) {
	...
	@Override
	public IMethodInfo unwrapConstructorInfo(final IMethodInfo constructor, ITypeInfo objectType) {
		GeneratedConstructorInfoProxy proxy = (GeneratedConstructorInfoProxy) constructor;
		if (!proxy.factory.equals(InfoProxyFactory.this)) {
			throw new ReflectionUIError();
		}
		return proxy.base;
	...
	@Override
	public IParameterInfo unwrapParameterInfo(final IParameterInfo param, IMethodInfo method, ITypeInfo objectType) {
	...
	@Override
	public IEnumerationItemInfo unwrapEnumerationItemInfo(final IEnumerationItemInfo itemInfo,
			IEnumerationTypeInfo parentEnumType) {
		GeneratedEnumerationItemInfoProxy proxy = (GeneratedEnumerationItemInfoProxy) itemInfo;
		if (!proxy.factory.equals(InfoProxyFactory.this)) {
			throw new ReflectionUIError();
		}
		return proxy.base;
	 ...
	 *         current factory.
	 */
	public boolean isWrappingFieldInfo(final IFieldInfo field, ITypeInfo objectType) {
	 ...
	 *         current factory.
	 */
	public boolean isWrappingMethodInfo(final IMethodInfo method, ITypeInfo objectType) {
	...
	/**
	 * @param constructor The constructor information to analyze.
	 * @param objectType  The parent object type information.
	 * @return whether the given constructor information is a proxy generated by the
	 *         current factory.
	 */
	public boolean isWrappingConstructorInfo(final IMethodInfo constructor, ITypeInfo objectType) {
		if (!(constructor instanceof GeneratedConstructorInfoProxy)) {
			return false;
		}
		GeneratedConstructorInfoProxy proxy = (GeneratedConstructorInfoProxy) constructor;
		if (!proxy.factory.equals(InfoProxyFactory.this)) {
	 ...
	 *         current factory.
	 */
	public boolean isWrappingParameterInfo(final IParameterInfo param, IMethodInfo method, ITypeInfo objectType) {
